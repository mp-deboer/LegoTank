...
2. Open any `.drawio` file in either an installed version of [draw.io](https://www.drawio.com/) or in a browser via [diagrams.net](https://app.diagrams.net/).
...
- Thin wrapper classes (`Sm_*.java`) in `../src/tankpack/` extend the generated classes and add project-specific logic.
